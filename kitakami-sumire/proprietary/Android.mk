...
LOCAL_MODULE_SUFFIX := .so
LOCAL_MODULE_OWNER := Sony Mobile
LOCAL_SRC_FILES := vendor/lib/libEGL_adreno.so
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_STEM := libEGL_adreno
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
LOCAL_MULTILIB := 32
...
LOCAL_MODULE_SUFFIX := .so
LOCAL_MODULE_OWNER := Sony Mobile
LOCAL_SRC_FILES := vendor/lib/libhwdaphal.so
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_STEM := libhwdaphal
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
LOCAL_MULTILIB := 32
LOCAL_STRIP_MODULE := false
LOCAL_MODULE_PATH := $(TARGET_OUT)/vendor/lib
...
LOCAL_MODULE_SUFFIX := .so
LOCAL_MODULE_OWNER := Sony Mobile
LOCAL_SRC_FILES := vendor/lib64/libEGL_adreno.so
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_STEM := libEGL_adreno
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
LOCAL_MULTILIB := 64
...
LOCAL_MODULE_SUFFIX := .so
LOCAL_MODULE_OWNER := Sony Mobile
LOCAL_SRC_FILES := vendor/lib64/libhwdaphal.so
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_STEM := libhwdaphal
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
LOCAL_MULTILIB := 64
